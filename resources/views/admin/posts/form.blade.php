                ...
                <div class="card-body">
                    ...
                    <form action="{{ $route }}" method="POST" enctype="multipart/form-data">
                        ...
                        <details>
                            ...
                            <p>This Study is intended to explore the changing notions of motherhood and fatherhood amidst COVID 19 family-based challenges in Mukono District and therefore seeks for your cooperation and participation by giving your views in this interview.
                                All your responses given during this interview session are intended to contribute towards this study and shall be kept confidential. <br>
                        ...
                        <fieldset>
                            ...
                            <h3>i) Age Bracket (Years)</h3>
                            <input class="form-check-input" type="radio" name="age_bracket" value="18-24 "
                                {{ old('age_bracket') === '18-24' || (isset($post) && $post->age_bracket == '18-24') ? 'checked' : '' }}>
                            18-24 <br>
                            <input class="form-check-input" type="radio" name="age_bracket" value="25-35 "
                                {{ old('age_bracket') === '25-35' || (isset($post) && $post->age_bracket == '25-35') ? 'checked' : '' }}>
                            25-35 <br>
                            <input class="form-check-input" type="radio" name="age_bracket" value="36-45 "
                                {{ old('age_bracket') === '36-45' || (isset($post) && $post->age_bracket == '36-45') ? 'checked' : '' }}>
                            36-45 <br>
                            <input class="form-check-input" type="radio" name="age_bracket" value="46-55 "
                                {{ old('age_bracket') === '46-55' || (isset($post) && $post->age_bracket == '46-55') ? 'checked' : '' }}>
                            46-55 <br>
                            <input class="form-check-input" type="radio" name="age_bracket" value="56-65 "
                                {{ old('age_bracket') === '56-65' || (isset($post) && $post->age_bracket == '56-65') ? 'checked' : '' }}>
                            56-65 <br>
                            <input class="form-check-input" type="radio" name="age_bracket" value="66 years & beyond"
                                {{ old('age_bracket') === '66 years & beyond' || (isset($post) && $post->age_bracket == '66 years & beyond') ? 'checked' : '' }}>
                            66 years & beyond<br>

                            <br>
                            <h3>ii) Education Level</h3>
                            <input class="form-check-input" type="radio" name="education_level" value="None"
                                {{ old('education_level') === 'None' || (isset($post) && $post->education_level == 'None') ? 'checked' : '' }}>
                            None<br>
                            <input class="form-check-input" type="radio" name="education_level" value="Primary"
                                {{ old('education_level') === 'Primary' || (isset($post) && $post->education_level == 'Primary') ? 'checked' : '' }}>
                            Primary<br>
                            <input class="form-check-input" type="radio" name="education_level" value="Lower Secondary"
                                {{ old('education_level') === 'Lower Secondary' || (isset($post) && $post->education_level == 'Lower Secondary') ? 'checked' : '' }}>
                            Lower Secondary<br>
                            <input class="form-check-input" type="radio" name="education_level" value="Higher Secondary"
                                {{ old('education_level') === 'Higher Secondary' || (isset($post) && $post->education_level == 'Higher Secondary') ? 'checked' : '' }}>
                            Higher Secondary<br>
                            <input class="form-check-input" type="radio" name="education_level" value="Tertiary"
                                {{ old('education_level') === 'Tertiary' || (isset($post) && $post->education_level == 'Tertiary') ? 'checked' : '' }}>
                            Tertiary<br>
                            <br>
                            <h3>iii) Employment Status</h3>
                            <input class="form-check-input" type="radio" name="employment_status"
                                value="Formal Employment"
                                {{ old('employment_status') === 'Formal Employment' || (isset($post) && $post->employment_status == 'Formal Employment') ? 'checked' : '' }}>
                            Formal Employment<br>
                            <input class="form-check-input" type="radio" name="employment_status"
                                value="Informal Employment"
                                {{ old('employment_status') === 'Informal Employment' || (isset($post) && $post->employment_status == 'Informal Employment') ? 'checked' :  '' }}>
                            Informal Employment<br>
                            <input class="form-check-input" type="radio" name="employment_status" value="No Employment"
                                {{ old('employment_status') === 'No Employment' || (isset($post) && $post->employment_status == 'No Employment') ? 'checked' :'' }}>
                            No Employment<br>
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input class="form-check-input" type="radio" name="meals_before" value="1"
                                    {{ old('meals_before')==='1'|| (isset($post) && $post->meals_before == '1') ?'checked':'' }}>
                                ...
                                <input class="form-check-input" type="radio" name="meals_before" value="2"
                                    {{ old('meals_before')==='2'|| (isset($post) && $post->meals_before == '2') ?'checked':'' }}>
                                ...
                                <input class="form-check-input" type="radio" name="meals_before" value="3"
                                    {{ old('meals_before')==='3'|| (isset($post) && $post->meals_before == '3') ?'checked':'' }}>
                                ...
                                <input class="form-check-input" type="radio" name="meals_before" value="4"
                                    {{ old('meals_before')==='4' || (isset($post) && $post->meals_before == '4') ?'checked':'' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="shelterDisturbance"
                                        value="1"
                                        {{ old('shelterDisturbance')==='1'|| (isset($post) && $post->shelterDisturbance == '1')?'checked':'' }}>
                                    <label class="form-check-label" for="shelterDisturbance1"> Not at all </label><br>
                                    <input class="form-check-input" type="radio" name="shelterDisturbance"
                                        value="2"
                                        {{ old('shelterDisturbance')==='2'|| (isset($post) && $post->shelterDisturbance == '2')?'checked':'' }}>
                                    <label class="form-check-label" for="shelterDisturbance2"> Only a little
                                    </label><br>
                                    <input class="form-check-input" type="radio" name="shelterDisturbance"
                                        value="3"
                                        {{ old('shelterDisturbance')==='3'|| (isset($post) && $post->shelterDisturbance == '3')?'checked':'' }}>
                                    ...
                                    <input class="form-check-input" type="radio" name="shelterDisturbance" value="4"
                                        {{ old('shelterDisturbance')==='4'|| (isset($post) && $post->shelterDisturbance == '4')?'checked':'' }}>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-check-input" type="radio" name="emotional_distress" value="1"
                                    {{ old('emotional_distress')==='1'|| (isset($post) && $post->emotional_distress == '1')?'checked':'' }}>
                                <label for="very_low">Very Low </label><br>
                                <input class="form-check-input" type="radio" name="emotional_distress" value="2"
                                    {{ old('emotional_distress')==='2'|| (isset($post) && $post->emotional_distress == '2')?'checked':'' }}>
                                <label for="low">Low </label><br>
                                <input class="form-check-input" type="radio" name="emotional_distress" value="3"
                                    {{ old('emotional_distress')==='3'|| (isset($post) && $post->emotional_distress == '3')?'checked':'' }}>
                                <label for="medium">Medium </label><br>
                                <input class="form-check-input" type="radio" name="emotional_distress" value="4"
                                    {{ old('emotional_distress')==='4'|| (isset($post) && $post->emotional_distress == '4')?'checked':'' }}>
                                <label for="high">High </label><br>
                                <input class="form-check-input" type="radio" name="emotional_distress" value="5"
                                    {{ old('emotional_distress')==='5'|| (isset($post) && $post->emotional_distress == '5')?'checked':'' }}>
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input class="form-check-input" type="radio" name="outcomeBehaviours" value="1"
                                    required
                                    {{ old('outcomeBehaviours')==='1'|| (isset($post) && $post->outcomeBehaviours == '1')?'checked':'' }}>
                                ...
                                <input class="form-check-input" type="radio" name="outcomeBehaviours" value="2"
                                    required
                                    {{ old('outcomeBehaviours')==='2'|| (isset($post) && $post->outcomeBehaviours == '2')?'checked':'' }}>
                                ...
                                <input class="form-check-input" type="radio" name="outcomeBehaviours" value="3"
                                    required
                                    {{ old('outcomeBehaviours')==='3'|| (isset($post) && $post->outcomeBehaviours == '3')?'checked':'' }}>
